...
public class TransponderListBinder extends ViewBinder<TransponderEnt> {

    private ListItemClickListener itemClickListener;

    public TransponderListBinder(ListItemClickListener listener) {
        super(R.layout.row_item_transponder_list);
